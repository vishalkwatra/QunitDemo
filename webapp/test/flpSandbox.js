		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#DeferredTaxRollForward-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DeferredTaxRollForward-display": {
								"semanticObject": "DeferredTaxRollForward",
								"action": "display",
								"description": "Deferred Tax Roll Forward",
								"title": "Deferred Tax Roll Forward",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ey.sap.fin.cs.deferredtaxrollfwd",
									"url": sap.ui.require.toUrl("ey/sap/fin/cs/deferredtaxrollfwd")
								}
							}
						}
					}
