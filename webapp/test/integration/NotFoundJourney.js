...
sap.ui.define([
	...
	opaTest("Should see the resource not found page when changing to an invalid hash", function (Given, When, Then) {
		...
		Given.iStartMyFLPApp({
			intent: "DeferredTaxRollForward-display"
		});
	...
	opaTest("Should see the 'Object not found' page if an invalid object id has been called", function (Given, When, Then) {
		...
		Given.iStartMyFLPApp({
			intent: "DeferredTaxRollForward-display",
			hash: "ZEY_SAV_C_TrfReportingGaapResults/SomeInvalidObjectId"
		});
	...
	opaTest("Clicking the 'Show my worklist' link on the 'Object not found' page should bring me back to the worklist", function (Given,
		When, Then) {
		//Actions
