sap.ui.define([
	"sap/ui/test/Opa5",
	"ey/sap/fin/cs/deferredtaxrollfwd/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("ey.sap.fin.cs.deferredtaxrollfwd.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "ey.sap.fin.cs.deferredtaxrollfwd",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ZEY_SAV_C_TrfReportingGaapResults/" + sObjectId;
