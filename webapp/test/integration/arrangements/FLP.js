...
sap.ui.define([
	...
	"ey/sap/fin/cs/deferredtaxrollfwd/test/flpSandbox"
	...
	return Opa5.extend("ey.sap.fin.cs.deferredtaxrollfwd.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ZEY_SAV_C_TrfReportingGaapResults/" + encodeURIComponent(sObjectId);
